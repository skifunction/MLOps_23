...
for test_s in test_size:
    for dev_s in dev_size:
        ...
        best_hparams, best_model, best_accuracy = tune_hparams_SVM(X_train, y_train, dev_x, dev_y, possible_combination_SVM)
        best_hparams_DT, best_model_DT, best_accuracy_DT = tune_hparams_DT(X_train, y_train, dev_x, dev_y, possible_combination_DT)
